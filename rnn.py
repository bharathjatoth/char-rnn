...
def run(train_data, target_data, unique_chars, len_unique_chars):
    ...
    for i in range(epoch):
        ...
        seed = train_batch[:1:] # get the vectorized input here np.random.randn(1,42,40)
        ...
        for i in range(10):
            if i > 0:
                ...
                # seed = remove_fist_char
                print(remove_fist_char.shape)
            ...
            probabilities = sample(predicted) #size of 43
...
if __name__ == "__main__":
    ...
    text = read_data(r'data/nietzsche.txt')
